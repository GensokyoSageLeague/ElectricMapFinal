    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '江畔一日游' + '</div>' + '<br/>' + '<div class="point_content_title">' + '评分：【4.7】' + '</div>' + '<br/>' + '<div class="point_content_title">' + '攻略简介：' + '<div class="point_content_discribe">' + '紧邻长江，将长江边上的燕子矶风光和长江观音风光一览无余之后，在城北的迈皋桥吃上一顿热火朝天的火锅，\n再到不远处的彩虹广场逛逛，美好的一天就这样结束了!' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：' + '燕子矶公园-长江观音景区-重庆捞翻天火锅-晓庄国际彩虹广场' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '给我评分：' + '< id="wrapper">' +
			...
			'</div>' + '<br/>' + '<div class="point_content_picture"><img src ="信息窗口动图/1101.gif"><div>'
                // 创建信息窗口对象 		
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '马群周边游'+'</div>' + '<br/>'+'评分：AAAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：这条线路适合生活在马群附近的朋友们，在钟山风景名胜区走走，\n晌午，到花园城吃一餐晋家门。走了一天肯定累了，再去按按脚吧。休息片刻，还有一场精彩绝伦的电影等着你和你的爱人！' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：花园城-幸福蓝海国际影城-水沐足韵-晋家门' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '仙林度假游' + '</div>' + '<br/>' + '评分：AAAAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：美丽的仙林，值得我们不停探索。免费的仙林湖公园是天然氧吧，和伴侣、孩子、父母来都是极好的。不远处就是新开的万达茂了，我猜时尚年轻你一定喜欢英国的牛排，或者是韩国的烤肉！吃完这一餐，再来杯星巴克润润嗓子，别忘了，三楼还有一家大玩家等着你释放年轻的激情！' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：仙林湖公园-诺丁牛排-汉拿山-星巴克-大玩家' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '栖霞人文游' + '</div>' + '<br/>' + '评分：AAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：在栖霞山风景名胜区欣赏自然风光，放松心灵，之后来到仙林大学城，感受浓郁的大学氛围与青春气息。PS:没有什么事情是一顿火锅解决不了的！' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：栖霞山=金鹰湖滨天地-左庭右院鲜牛肉火锅-南京师范大学' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '青年休闲游' + '</div>' + '<br/>' + '评分：AAAAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：羊山公园作为原生态森林公园自然是开启元气满满的一天的首选，此外这里还有真人CS体验基地适合老中青三代在此度过美好时光，稍晚些可以来到东城汇，这里有火锅烧烤，有西餐快餐，KT与乱世佳人酒吧也可以让你的夜生活丰富多彩！' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：羊山公园-东城汇-唯爱主题KTV-乱世佳人酒吧' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '懒癌患者游' + '</div>' + '<br/>' + '评分：AAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：不想一直走走走！那么这会是你最佳选择。在万达茂吃喝玩乐一应俱全，大玩家游戏城让你体验游戏的乐趣，汉拿山烧烤让你体验饱腹的快感，之后再和三五好友一起网上冲浪，看场电影，岂不快哉！' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：南京万达茂-大玩家-汉拿山-青春飞扬网咖-卢米埃影院' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '心灵净化游' + '</div>' + '<br/>' + '评分：AAAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：在栖霞山看完美不胜收的红叶不如体验一下正宗素斋，下午再游玩栖霞古寺来一场净化心灵之旅。购物和吃肉的狂欢就偷偷留给夜晚~' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：栖霞山-千佛寨素菜馆-栖霞古寺-汉拿山-南京万达茂' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '城乡养生游' + '</div>' + '<br/>' + '评分：AAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：美好的早晨就在湿地公园享受一下清新自然的味道吧。接下来回到闹市，火锅K歌大保健一条龙，让我们红尘作伴活得潇潇洒洒。' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：八卦洲湿地公园-重庆捞翻天火锅-优力锋KTV-玖古养生' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '单身贵族游' + '</div>' + '<br/>' + '评分：AAAAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：一个人的一天也要精彩又尽兴。看完电影买买买，再吃顿火锅好好犒劳自己。下午变身神探加入推理俱乐部，夜晚以一群人的狂欢收尾。' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：卢米埃影院-金鹰湖滨天地-川西集市-九霄推理俱乐部-乱世佳人酒吧' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '情侣虐狗游' + '</div>' + '<br/>' + '评分：A' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：和亲爱的TA要怎么度过闲暇时光呢？不如和TA一起到仙林湖划划船，到影院看一部甜蜜爱情片，最后再一起饱餐一顿。' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：仙林湖公园-卢米埃影院-咸亨酒店-金鹰湖滨天地' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '好友欢脱游' + '</div>' + '<br/>' + '评分：AAAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：和好友的欢聚时光，就应该是吃吃喝喝，而不用考虑其它的事。' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：八卦洲湿地公园-陌上花渡-柠檬鱼' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
    ...
    function addinformation(lines) {
        for (var line in lines) {
            ...
            myline.addEventListener("click", function () {
                ...
                //添加信息窗口内容
                var content = '<div class="point_content_title">' + '文艺赏景游' + '</div>' + '<br/>' + '评分：AAAA' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '攻略简介：这是个赏秋景最美的地方，有红枫也有情怀。' + '</div>' + '<br/>' +
                '<div class="point_content_discribe">' + '路线：千佛岩-天开岩-栖霞山-千佛寨素菜馆' + '</div>' + '<br/>' + '<div class="point_content_discribe">' + '祝您本次出行一切顺利开心，欢迎您在行程结束后给本次线路规划评分！' + '</div>' + '<br/>' + '<div id="wrapper">' +
			'<input type="radio" id="star1" name="star" />' +
			'<label for="star1"></label>' +
			'<input type="radio" id="star2" name="star" />' +
			'<label for="star2"></label>' +
